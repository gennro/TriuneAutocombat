...
│   │                           # Includes all shared utilities: navigation, spell helpers, class detection
│   ├── triune_spellbook.lua  # Standalone spellbook browser + memorization queue
│   │                           # Includes spell parsing and caching functions
│   └── triune_cursor.lua     # Standalone cursor item manager
│                               # Includes cursor management functions
├── config/
