...
| `/ac nms list [Box]` | | `#nms list` here or on a box; the items show in the window with action buttons |
| `/ac nms loot <keep\|sell\|tribute\|bank\|vault\|destroy\|pass> "Item Name"` | `/ac nms keep "Item"` | Act on one offered item by name (`#nms loot ...`) |
